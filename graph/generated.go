...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Movie.categories":
		if e.complexity.Movie.Categories == nil {
			break
		}

		return e.complexity.Movie.Categories(childComplexity), true
...
func (ec *executionContext) field_Mutation_createCategory_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNNewCategory2golangᚑgraphqlᚋgraphᚋmodelᚐNewCategory(ctx, tmp)
	}
...
func (ec *executionContext) field_Mutation_createMovie_argsInput(
	...
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNNewMovie2golangᚑgraphqlᚋgraphᚋmodelᚐNewMovie(ctx, tmp)
	}
...
func (ec *executionContext) _Category_movies(ctx context.Context, field graphql.CollectedField, obj *model.Category) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNMovie2ᚕᚖgolangᚑgraphqlᚋgraphᚋmodelᚐMovieᚄ(ctx, field.Selections, res)
}

func (ec *executionContext) fieldContext_Category_movies(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Category",
		Field:      field,
		IsMethod:   false,
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "categories":
				return ec.fieldContext_Movie_categories(ctx, field)
			}
...
func (ec *executionContext) _Movie_categories(ctx context.Context, field graphql.CollectedField, obj *model.Movie) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Movie_categories(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_Movie_categories(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Movie",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _Mutation_createMovie(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Movie)
	fc.Result = res
	return ec.marshalNMovie2ᚖgolangᚑgraphqlᚋgraphᚋmodelᚐMovie(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputNewMovie(ctx context.Context, obj any) (model.NewMovie, error) {
	...
	fieldsInOrder := [...]string{"title", "description", "releaseDate", "categoryId"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) _Movie(ctx context.Context, sel ast.SelectionSet, obj *model.Movie) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "categories":
			out.Values[i] = ec._Movie_categories(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		default:
...
func (ec *executionContext) marshalNMovie2golangᚑgraphqlᚋgraphᚋmodelᚐMovie(ctx context.Context, sel ast.SelectionSet, v model.Movie) graphql.Marshaler {
	return ec._Movie(ctx, sel, &v)
}

func (ec *executionContext) marshalNMovie2ᚕᚖgolangᚑgraphqlᚋgraphᚋmodelᚐMovieᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Movie) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNMovie2ᚖgolangᚑgraphqlᚋgraphᚋmodelᚐMovie(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNMovie2ᚖgolangᚑgraphqlᚋgraphᚋmodelᚐMovie(ctx context.Context, sel ast.SelectionSet, v *model.Movie) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNNewCategory2golangᚑgraphqlᚋgraphᚋmodelᚐNewCategory(ctx context.Context, v any) (model.NewCategory, error) {
	res, err := ec.unmarshalInputNewCategory(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) unmarshalNNewMovie2golangᚑgraphqlᚋgraphᚋmodelᚐNewMovie(ctx context.Context, v any) (model.NewMovie, error) {
